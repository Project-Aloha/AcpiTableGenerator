...
#define GICD_BASE_ADDRESS 0xEBC00000ULL
#define GICR_BASE_ADDRESS 0xEBC80000ULL
#define GIC_ITS_BASE_ADDRESS 0xEBC40000ULL

#define GICR_STRIDE 0x40000ULL
#define GIC_VERSION GIC_V4
...
#define GICC_MPIDR_CORE8 0x00000800ULL
#define GICC_MPIDR_CORE9 0x00000900ULL
#define NUM_ITS 1
...
MADT_START{
    ...
    MADT_DECLARE_GICC_STRUCTURE(8, 8, GICC_MPIDR_CORE8), // Core 8
    MADT_DECLARE_GICC_STRUCTURE(9, 9, GICC_MPIDR_CORE9), // Core 9
} MADT_END;
