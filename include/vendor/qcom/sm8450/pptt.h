...
PPTT_START{
    ...
    //  - parents: Cluster 0
    //  - private resources: L1I, L1D
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        0, 0, PPTT_REFERENCE_CLUSTER(0), PPTT_REFERENCE_CACHE(4),
        PPTT_REFERENCE_CACHE(5)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        1, 1, PPTT_REFERENCE_CLUSTER(0), PPTT_REFERENCE_CACHE(4),
        PPTT_REFERENCE_CACHE(5)),
    // Cluster 1 CPUs (2 cores)
    //  - parents: Cluster 1
    //  - private resources: L1I, L1D
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        2, 2, PPTT_REFERENCE_CLUSTER(1), PPTT_REFERENCE_CACHE(4),
        PPTT_REFERENCE_CACHE(5)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        3, 3, PPTT_REFERENCE_CLUSTER(1), PPTT_REFERENCE_CACHE(4),
        PPTT_REFERENCE_CACHE(5)),
    // Cluster 2 CPUs (3 cores)
    //  - parents: Cluster 2
    ...
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        ...
        PPTT_REFERENCE_CACHE(3)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        6, 6, PPTT_REFERENCE_CLUSTER(2), PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),

    // Cluster 3 CPU (1 core)
    //  - parents: Cluster 3
    //  - private resources: L1I, L1D, L2
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
