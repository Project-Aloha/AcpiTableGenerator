...
// ============================================
// 平台配置 - SM8250 (Snapdragon 865)
// ============================================

// OEM 信息
#define PPTT_OEM_ID                     {'Q', 'C', 'O', 'M', ' ', ' '}
#define PPTT_OEM_TABLE_ID               {'Q', 'C', 'O', 'M', 'E', 'D', 'K', '2'}
#define PPTT_OEM_REVISION               0x00008250

// CPU 拓扑配置
#define NUM_CORES                       8
#define NUM_CLUSTERS                    3
#define CLUSTER0_CORES                  4       // E-Core (Cortex-A55)
#define CLUSTER1_CORES                  3       // M-Core (Cortex-A77)
#define CLUSTER2_CORES                  1       // P-Core (Cortex-A77)
